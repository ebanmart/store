...
const Footer = () => {
  ...
  return (
    <div className="pb-16 lg:pb-0 xl:pb-0 bg-[#F9FAFB]">
              ...
              <ul className="text-sm flex flex-col space-y-3">
                <li className="flex items-baseline">
                  <Link
                    ...
                    className="text-gray-600 inline-block w-full hover:text-[#1E73BE]"
                  >
                    <CMSkeleton
                      count={1}
                      height={10}
            ...
            <div className="col-span-1 text-center hidden lg:block md:block">
              {storeCustomizationSetting?.footer?.bottom_contact_status && (
                <div>
                  ...
                  <h5 className="text-2xl font-bold text-[#1E73BE] leading-7">
                    {/* +012345-67900 */}
      ...
      <div className="mx-auto max-w-screen-2xl px-3 sm:px-10 flex justify-center py-4">
        <p className="text-sm text-gray-500 leading-6">
          Copyright 2024 @ Ebanmart , All rights reserved.
        </p>
      </div>
    </div>
  );
