            ...
            <div className="mx-auto px-3 lg:px-10 max-w-screen-2xl">
              <div className="flex items-center pb-4">
                <ol className="flex items-center w-full overflow-hidden font-serif">
                  <li className="text-sm pr-1 transition duration-200 ease-in cursor-pointer hover:text-[#1E73BE] font-semibold">
                    <Link href="/">Home</Link>
                  </li>
                  ...
                  <li className="text-sm pl-1 transition duration-200 ease-in cursor-pointer hover:text-[#1E73BE] font-semibold ">
                    <Link
                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            ...
                            <ul className="flex mt-4">
                              <li className="flex items-center text-center border border-gray-100 rounded-full hover:bg-[#1E73BE]  mr-2 transition ease-in-out duration-500">
                                <FacebookShareButton
