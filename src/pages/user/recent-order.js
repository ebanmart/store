        ...
        <div className="rounded-md font-serif">
          {loading ? (
            ...
            <div className="text-center">
              <span className="flex justify-center my-30 pt-16 text-[#1E73BE] font-semibold text-6xl">
                <IoBagHandle />
              </span>
                        ...
                        {data?.orders?.map((order) => (
                          <tr key={order._id}>
                            ...
                            <td className="px-5 py-3 whitespace-nowrap text-right text-sm">
                              <Link
                                className="px-3 py-1 bg-emerald-100 text-xs text-emerald-600 hover:bg-[#1E73BE] hover:text-white transition-all font-semibold rounded-full"
