          ...
          <div className="grid md:grid-cols-2 gap-6 lg:grid-cols-3 xl:gap-8 font-serif">
            {loading ? (
              ...
              <div className="border p-10 rounded-lg text-center">
                <span className="flex justify-center text-4xl text-[#1E73BE] mb-4">
                  <FiMail />
                </span>
              ...
              >
                ...
                <div className="flex flex-col space-y-5">
                  ...
                  <div className="relative">
                    <button
                      data-variant="flat"
                      className="md:text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border-0 border-transparent rounded-md placeholder-white focus-visible:outline-none focus:outline-none bg-[#1E73BE] text-white px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 hover:text-white  h-12 mt-1 text-sm lg:text-base w-full sm:w-auto"
                    >
