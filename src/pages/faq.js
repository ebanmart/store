          ...
          <div className="grid gap-4 lg:mb-8 items-center md:grid-cols-2 xl:grid-cols-2">
            ...
            <div className="">
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:text-[#1E73BE] bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                      <span>
                      ...
                      <ChevronUpIcon
                        className={`${
                          open ? "transform rotate-180 text-[#1E73BE]" : ""
              ...
              <Disclosure as="div" className="mt-2">
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:text-[#1E73BE] bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none">
                      <span>
                        {" "}
                        {showingTranslateValue(
