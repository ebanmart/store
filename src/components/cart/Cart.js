      ...
      <div className="flex flex-col w-full h-full justify-between items-middle bg-white rounded cursor-pointer">
            ...
            <div className="flex flex-col h-full justify-center">
              <div className="flex flex-col items-center">
                <div className="flex justify-center items-center w-20 h-20 rounded-full bg-emerald-100">
                  <span className=" text-[#1E73BE] text-4xl block">
                    <IoBagHandle />
                  </span>
                </div>
        ...
        <div className="mx-5 my-3">
          <button
            ...
            className="w-full py-3 px-3 rounded-lg bg-[#1E73BE]  flex items-center justify-between bg-heading text-sm sm:text-base text-white focus:outline-none transition duration-300"
          >
            <span className="align-middle font-medium">
              Proceed To Checkout
            </span>
            <span className="rounded-lg font-bold py-2 px-3 bg-white text-[#1E73BE]">
              {currency}
              {cartTotal.toFixed(2)}
            </span>
          </button>
