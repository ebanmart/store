...
const CategoryCarousel = () => {
  ...
  return (
    <>
      ...
      >
        {error ? (
          <p className="flex justify-center align-middle items-center m-auto text-xl text-[#1E73BE]">
            <span> {error}</span>
          </p>
        ) : (
          <div>
            {data[0]?.children?.map((category, i) => (
              <SwiperSlide key={i + 1} className="group">
                ...
                >
                  ...
                  <h3 className="text-xs text-gray-600 mt-2 font-serif group-hover:text-[#1E73BE]">
