        ...
        <div className="flex justify-between items-center">
          <div className="lg:w-3/5">
            ...
            <Link
              ...
              className="lg:w-1/3  text-xs font-serif font-medium inline-block mt-5 px-8 py-3 bg-[#1E73BE] text-center text-white rounded-full hover:text-white contact-btn"
              target="_blank"
            >
