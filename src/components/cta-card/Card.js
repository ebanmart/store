          ...
          <Link href={item.url} className="block">
            ...
            <div className="absolute top-0 left-0 z-10 p-r-16 flex-col flex w-full text-center justify-center">
              <div className="pt-4">
                ...
                <button className="hidden sm:block lg:block text-xs mx-auto leading-6 font-serif font-medium mt-4 px-4 py-1 bg-[#1E73BE] text-center rounded-full text-white ">
                  Shop Now
                </button>
              </div>
            </div>
