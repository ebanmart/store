      ...
      <Link href={`/product/${product.slug}`} passHref>
        ...
        <div className="group box-border overflow-hidden flex  shadow-sm pe-0 flex-col items-center p-3 rounded-lg w-[15rem] bg-[#F1F5F9] relative">
          ...
          <div className="w-full px-3 lg:px-4 pb-4 overflow-hidden">
            ...
            <div className="flex space-y-2 text-left flex-col  text-heading text-sm sm:text-base space-s-2 md:text-base lg:text-xl">
              <Price
                card
                product={product}
                currency={currency}
                  ...
                  {items.map(
                    (item) =>
                      item.id === product._id && (
                        <div
                          key={item.id}
                          className="h-9 w-auto flex flex-wrap items-center justify-evenly py-1 px-2 bg-[#1E73BE] text-white rounded"
                        >
                          <button
                            onClick={() =>
